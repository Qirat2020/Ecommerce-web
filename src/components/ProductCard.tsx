...
const ProductCard = ({ id, img, name, sale, price }: IProduct) => {
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        {sale && (
          <div className="bg-red-500 inline-block absolute top-0 left-0 text-[14px] text-white rounded-md px-2 py-[2px] m-4">
            SALE!
          </div>
        )}
